...
@objc class FFT : NSObject {
    ...
    //public var distanceShift : Float
    ...
    /*func calculateDistanceShift(time_interval : Float) -> Float {
        self.distanceShift += self.velocity * time_interval
        return self.distanceShift
    }*/
